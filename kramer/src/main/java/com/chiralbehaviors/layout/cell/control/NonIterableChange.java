...
public abstract class NonIterableChange<E> extends Change<E> {
    ...
    public String toString() {
        ...
        if (wasPermutated()) {
            ...
            ret = ChangeHelper.addRemoveChangeToString(from, to, getList(),
                                                       getRemoved());
        }
        invalid = oldInvalid;
        return "{ " + ret + " }";
    ...
    public static class GenericAddRemoveChange<E> extends NonIterableChange<E> {
        ...
        public GenericAddRemoveChange(int from, int to, List<E> removed,
    ...
    public static class SimpleRemovedChange<E> extends NonIterableChange<E> {
        ...
        public SimpleRemovedChange(int from, int to, E removed,
                                   ObservableList<E> list) {
            super(from, to, list);
    ...
    public static class SimplePermutationChange<E>
        ...
        public SimplePermutationChange(int from, int to, int[] permutation,
                                       ObservableList<E> list) {
            super(from, to, list);
